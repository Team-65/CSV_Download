...
public class CsvWriteReadTest {
	...
	public static void main(String[] args) {
		...
		String fileName ="potato.csv";  // System.getProperty("user.home") +   //name to be used for csv file
		String[] csv_data = {"color","shape","wer", "test", "lol", "potato"};  //creation of an array of strings to be written in the csv file
		System.out.println("Write CSV file:");
		CsvFileWriter.writeCsvFile(fileName,true,"C:/Users/Jacob/Downloads/", csv_data);
